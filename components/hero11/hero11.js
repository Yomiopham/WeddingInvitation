...
import hero1 from '/public/images/slider/hero-12.jpg'
import hero2 from '/public/images/slider/hero-13.jpg'
import hero3 from '/public/images/slider/hero-14.jpg'
                                            ...
                                            SlideArray.map((hero, sld) => (
                                                <div className="wpo-static-hero-inner" key={sld}>
                                                    ...
                                                    <div data-swiper-parallax="400" className="slide-btn-wtap">
                                                        <ul>
                                                            <li><Link href="/shop" className="theme-btn">Shop Now</Link></li>
                                                            <li><Link href="/wishlist"><i className="fi flaticon-heart"></i></Link></li>
                                                        </ul>
                                                    </div>
