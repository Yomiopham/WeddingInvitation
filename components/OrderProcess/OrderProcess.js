...
import cImg1 from '/public/images/order/img-1.jpg'
import cImg2 from '/public/images/order/img-2.jpg'
import cImg3 from '/public/images/order/img-3.jpg'
import cImg4 from '/public/images/order/img-4.jpg'
...
const OrderProcess = () => {
    return (
        <section className="wpo-order-section section-padding">
            <div className="shape" style={{ backgroundImage: `url(${'/images/order/bg.png'})` }}></div>
