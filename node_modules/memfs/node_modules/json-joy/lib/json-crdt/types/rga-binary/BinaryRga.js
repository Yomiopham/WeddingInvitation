...
class BinaryChunk {
    ...
    split(ticks) {
        if (!this.del) {
            ...
            const chunk = new BinaryChunk((0, clock_1.tick)(this.id, ticks), this.span - ticks, rightBuffer);
            this.data = data.subarray(0, ticks);
            this.span = ticks;
            return chunk;
        }
        const chunk = new BinaryChunk((0, clock_1.tick)(this.id, ticks), this.span - ticks, undefined);
        this.span = ticks;
        return chunk;
    }
    delete() {
...
class BinaryRga extends AbstractRga_1.AbstractRga {
    constructor() {
        super(...arguments);
        this._view = null;
        this.api = undefined;
